    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="relative flex flex-col w-full max-w-4xl m-6 bg-white shadow-2xl rounded-2xl md:flex-row">
            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center p-8 md:p-12">
                ...
                <p class="mt-2 text-gray-600">Silakan masuk untuk mengakses sistem.</p>
                ...
                <form class="mt-6" method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="nama@satoria.com" required autofocus autocomplete="username" value="{{ old('email') }}">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="relative">
                            <input id="password" type="password" name="password" required autocomplete="current-password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="••••••••">
