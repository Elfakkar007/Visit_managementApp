    ...
    <form wire:submit.prevent="update">
        <div class="space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-4 border-t">
                <a href="{{ route('admin.workflows.index') }}" class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700">
                    Batal
                </a>
